...
Active canonical pages: 12

## Concepts

- [[alternative-scoring]] - 대안 여행지 후보를 연관도, 한적함, 거리, 조건 적합도로 점수화하는 정책.
- [[congestion-diagnosis]] - 방문 시점의 집중률을 백분위 등급으로 변환하는 진단 정책.
- [[course-generation-policy]] - 목적지와 대안지를 시간대별로 배치하는 코스 생성 정책.
...
- [[why-this-place-today]] - 오늘 이 여행지와 코스가 적합한 이유를 설명하기 위한 근거 질의.
...
No active comparison pages yet.
